...
I wanted to design a dev board for every single ESP32 module.

So, I did what everyone on the internet is telling you to do right now. I asked the AI to spin up a *team of agents* to design the boards for me.

It's response was - stop wasting my time - this is a mechanical job. You don't want a swarm of agents randomly wiring things up, you want some deterministic scripts.

So I let it write those for me.

**[CUT TO: the terminal time-lapse — boards rendering one after another — then a grid of all 12 finished boards rotating in 3D.]**

And there we go twelve nice little fully routed dev boards.
